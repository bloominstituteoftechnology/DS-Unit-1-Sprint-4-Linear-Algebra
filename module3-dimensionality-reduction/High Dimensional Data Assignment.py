...
# asdf = []
# for i in range(300):
#   asdf.append(national.copy())

# Get One-Hot-Encoding of categorical variables
national_processed = pd.get_dummies(national_sampled)


#%%
national_sampled.shape
...
new_cols = list(national_processed.columns[national_processed.dtypes!='object']).copy()
...
processed = scaler.fit_transform(national_processed[new_cols],y=national_processed[target])
